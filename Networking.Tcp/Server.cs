...
{
    /// <summary>
    /// Provides a <a href="https://docs.microsoft.com/en-us/dotnet/api/system.servicemodel.nettcpbinding?view=netframework-4.7.2">.Net WCF TCP Binding</a> implementation of the <see cref="ServerBase"/>.
    /// </summary>
    [Serializable]
    public class Server
        : BasicServerBase
