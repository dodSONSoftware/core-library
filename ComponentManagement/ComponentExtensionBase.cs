...
{
    /// <summary>
    /// Defines the base class for all components that will be running in the current <see cref="System.AppDomain"/>.
    /// </summary>
    /// <seealso cref="Addon"/>
    /// <seealso cref="Addon.ExtensionBase"/>
    /// <seealso cref="IComponent"/>
    [Serializable()]
    public abstract class ComponentExtensionBase
        : Addon.ExtensionBase,
          IComponent
    {
        #region Ctor
        ...
        /// </summary>
        protected ComponentExtensionBase() : base() { }
        #endregion
        ...
        /// </summary>
        /// <remarks>
        /// <b>For Inheritors of this class</b>: Do not override this method, override the <see cref="OnComponentStarted"/> instead. The OnStart() method should only be used by the framework.
        /// </remarks>
        protected override void OnStart()
        {
            var logs = new Logging.Logs();
            logs.Add(Logging.LogEntryType.Information, LogSourceId, $"Starting Extension Component {Id}");
            // open the client
            ...
            logs.Add(Logging.LogEntryType.Information, LogSourceId, $"Extension Component Started {Id}");
            Log.Write(logs);
        }
        /// <summary>
        ...
        /// </summary>
        /// <remarks>
        /// <b>For Inheritors of this class</b>: Do not override this method, override the <see cref="OnComponentStopping"/> instead. The OnStop() method should only be used by the framework.
        /// </remarks>
        protected override void OnStop()
        {
            var logs = new Logging.Logs();
            logs.Add(Logging.LogEntryType.Information, LogSourceId, $"Stopping Extension Component {Id}");
            // call abstract stop
            ...
            Client = null;
            // write all logs
            logs.Add(Logging.LogEntryType.Information, LogSourceId, $"Extension Component Stopped {Id}, Start Time={this.DateLastStarted}, Run Time={this.LastRunDuration}");
            Log.Write(logs);
        }
        #endregion
        ...
        /// </summary>
        /// <param name="message">The <see cref="Networking.IMessage"/> to process.</param>
