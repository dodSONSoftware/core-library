...
{
    /// <summary>
    /// Indicates whether the Get File Command was successful of not.
    /// </summary>
    [Serializable]
    public class GetFileComplete
    {
        #region Ctor
        private GetFileComplete()
        {
        }
        /// <summary>
        /// Instantiates a new instance of the <see cref="GetFileComplete"/> object with the given parameters.
        /// </summary>
        ...
        public GetFileComplete(bool transferSuccessful,
                               string description,
