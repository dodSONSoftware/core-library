...
namespace dodSON.Core.ServiceManagement.RequestResponseTypes
{
    ...
    /// </summary>
    [Serializable]
    public class WriteInstalledCustomConfiguration
    {
        #region Ctor
        private WriteInstalledCustomConfiguration()
        {
        }
        /// <summary>
        ...
        /// <summary>
        /// The name of the installed package to write the custom configuration to.
        /// </summary>
        public string Name
        {
            get;
        ...
        /// <summary>
        /// The version of the installed package to write the custom configuration to.
        /// </summary>
