...
{
    /// <summary>
    /// Provides a <a href="https://docs.microsoft.com/en-us/dotnet/standard/io/pipe-operations">.Net Named Pipes</a> implementation of the <see cref="ServerBase"/>.
    /// </summary>
    [Serializable]
    public class Server
        : BasicServerBase
    {
        ...
        /// </summary>
        public override Uri AddressUri => (new UriBuilder(string.Format("net.pipe://{0}/{1}", base.Address.IPAddress, NamedPipesShared.NamedPipeFullChannelName(this)))).Uri;
        /// <summary>
